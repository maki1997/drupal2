    ...
    attach: function (context) {
      ...
      $preview.once('navbar').each(function () {
        ...
        $preview.find('select[name="navbar_position"]').bind('change', function () {
          ...
          $navbar.removeClass('navbar-fixed-bottom navbar-fixed-top navbar-includes-top container');
          if ($position.length) {
          ...
          $body.removeClass('navbar-is-fixed-top navbar-is-fixed-bottom navbar-is-includes-top');
          switch ($position) {
            case 'fixed-top':
            ...
            case 'includes-top':
              $body.addClass('navbar-is-includes-top');
              break;
          }
        });
